...
const Connect = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-navy to-navy/95">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="glass-card p-6 rounded-xl hover:shadow-lg hover:shadow-teal/5 transition-all">
            ...
            <div className="bg-white/5 p-4 rounded-lg mb-4">
              <span className="text-teal text-sm font-medium">Latest Post</span>
              <h4 className="text-white font-medium mt-1">Implementing AI Agents in SwiftUI Apps</h4>
            </div>
            <a href="#" className="text-teal hover:underline flex items-center">
              Read Blog
          ...
          <div className="glass-card p-6 rounded-xl hover:shadow-lg hover:shadow-teal/5 transition-all">
            ...
            <div className="space-y-3">
              <a href="#" className="block bg-white/5 p-3 rounded-lg text-white hover:bg-white/10 transition-colors">
                <span className="text-teal text-sm">Free Download</span>
                <p className="text-white/90">Prompt Engineering Guide (PDF)</p>
              </a>
              <a href="#" className="block bg-white/5 p-3 rounded-lg text-white hover:bg-white/10 transition-colors">
                <span className="text-teal text-sm">GitHub</span>
          ...
          <div className="glass-card p-6 rounded-xl hover:shadow-lg hover:shadow-teal/5 transition-all">
            ...
            <div className="space-y-4">
              <a href="mailto:1294ravinder@gmail.com" className="block text-white hover:text-teal transition-colors">
                <span className="text-teal text-sm">Email</span>
